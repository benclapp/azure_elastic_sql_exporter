...
ADD . /go/src/github.com/benclapp/azure_elastic_sql_exporter
...
COPY --from=builder /go/src/github.com/benclapp/azure_elastic_sql_exporter/azure_elastic_sql_exporter /app/
